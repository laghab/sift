...
Package Sift as standalone binaries (no Python or system dependencies required) for Linux, macOS, and Windows. Provide install scripts and a documented release workflow.
