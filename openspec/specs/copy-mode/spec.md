...
Provide non-destructive operation modes for Sift — copying instead of moving matched files, and dry-run preview to see what would be matched without actually touching files.
